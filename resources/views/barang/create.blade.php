            ...
            <form action="{{route('barang.store')}}" method="post">
                ...
                <div class="row">
                    <div class="mb-3 col-6">
                        ...
                        <select class="form-select" name="jns_brg_kode" id="jns_brg_kode">
                            @foreach($jns as $j)
                            <option value="{{$j->jns_brg_kode}}">{{$j->jns_brg_kode}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3 col-6">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-6">
                        <label for="br_tgl_entry" class="form-label">Tanggal Entry Barang</label>
                        <input type="date" class="form-control" name="br_tgl_entry" id="br_tgl_entry">
                    </div>
                </div>
                <div class="mb-3">
